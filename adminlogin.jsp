...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style3">AgriResponse A Real Time Agricultural Query Response Generation System for Assisting Nationwide Farmers</h1>
      </div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <div class="clr"></div>
          <div class="img"><img src="images/Admin.jpg" width="198" height="208" alt="" class="fl" /></div>
