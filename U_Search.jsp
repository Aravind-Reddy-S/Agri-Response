...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style17">AgriResponse A Real Time Agricultural Query Response Generation System for Assisting Nationwide Farmers</a><a href="index.html"></a></h1>
      </div>
      ...
      <div class="mainbar">
        <div class="article">
		  ...
		  <form name="s" action="U_Search.jsp" method="post" onSubmit="return valid()"  ons target="_top">   
                  ...
                  <Table align="center" style="margin:0 0 0 30px;">
                    <tr>
                      <td width="174"><div align="center">
                        <div align="right" class="style12">
                          <div align="center" class="style6">Enter Your Question </div>
                        </div>
                      </div></td>
                      <td width="152">
                    ...
                    <tr>
                      <td COLSPAN="3"><div class="style2">
                        <div align="center" class="style13 style5">( Searching Datasets Based on Smart Agriculture,Crop,Season)</div>
                      </div></td>
                    </tr>
                  </Table>
               </div>
	 				 ...
	 				 try
						...
						long Stime1=System.currentTimeMillis();
								...
								while(rs8.next())
								    ...
								    s1 = rs8.getString(2); // Fid
									s2 = rs8.getString("sa"); // Smart Agriculture
									s3 = rs8.getString("cr"); // Crop
									s4 = rs8.getString("sn"); // Season
								...
								String t3=s5.toLowerCase();
					for( i=0;i<splitstr.length;i++)
					{
					
								if ( (t.contains(splitstr[i])) ||(t1.contains(splitstr[i])) ||(t2.contains(splitstr[i])) ||(t3.contains(splitstr[i])) )
									{
               ...
               <p class="style4"> 
               <div align="center" ><strong><span class="style5">Flow ID :</span> <span class="style8"><%=s1%></span> </strong>
                 </p>
</div>
             
                <p><div align="center" class="style5"><strong>View <a href="U_Search1.jsp?Fid=<%=s1%>">View Details</a></strong></div>
                </p>
                <p></p>
				<div>
				...
				long tt=(endtime1-Stime1);
				
				Statement st2=connection.createStatement(); 
				st2.executeUpdate("insert into td(qname,uname,dt,td) values('"+keyword+"','"+user+"','"+dt+"','"+tt+"') ");
					%>			
